...
TAROT.Help = "Rolls one of the following effects: Deal temporaly 50% extra damage, Receive 50% less damage, pay $10 every damage points received, receive $10 for every damage points dealt"
TAROT.Max = 3
TAROT.Rarity = 3
TAROT.Cost = 6000
TAROT.Skin = 2
